...
<?php echo $this->Form->create('Employee'); ?>
	...
	<?php
		$job = array('ASYSTENT' => 'Asystent', 'PROFESOR' => 'Profesor', 'ADIUNKT' => 'Adiunkt', 'DYREKTOR' => 'Dyrektor', 'SEKRETARKA' => 'Sekretarka', 'DOKTORANT' => 'Doktorant');
		echo $this->Form->input('nazwisko');
		echo $this->Form->input('imie');
		echo $this->Form->input('etat', array('options' => $job, 'default' => 'full'));
